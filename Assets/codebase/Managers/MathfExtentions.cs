...
//Center is 0,0  i flipped the axis on top and right bc i think they are messed up
public static class RectTransformExtensions
{
    ...
    {
        //FOR SOME REASON IT WAS -right. I dont get it bruuuuuh
...
{
    public static float SumLenght(Vector2 v)//Returns the abs of x + y, its much faster, but no where near accurate
    {
    ...
    //You better not give anything other thank 0,1 to the time
